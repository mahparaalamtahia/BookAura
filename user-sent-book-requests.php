...
$select = "
  ...
  WHERE service_request_pending_status = '1' AND user_id = '$id' 
...
if ($_SESSION['success_alert'] == '1') {
  ?>
  <script>
    swal({title: "Done!", text: "Book request sent successfully!", icon: "success", button: "OK"});
  </script>
  <?php
          ...
          <div class="card-header bg-light">
            <div class="row">
              <div class="col-md-10 card_header_text">
                <b>All Pending Book Requests Sent By You</b>
              </div>
